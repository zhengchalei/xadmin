...
class SysDepartmentControllerTest {
    ...
    fun createSysDepartment() {
        val result = mockMvc.post("/api/sys/department/create") {
    ...
    fun updateSysDepartmentById() {
        mockMvc.post("/api/sys/department/update") {
            content = objectMapper.writeValueAsString(
    ...
    fun findSysDepartmentList() {
        mockMvc.get("/api/sys/department/list")
            .andExpect {
                status { isOk() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
    ...
    fun findSysDepartmentTreeRoot() {
        mockMvc.get("/api/sys/department/tree-root")
            .andExpect {
                status { isOk() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
    ...
    fun findSysDepartmentPage() {
        mockMvc.get("/api/sys/department/page")
            .andExpect {
                status { isOk() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
    ...
    fun findSysDepartmentTree() {
        mockMvc.get("/api/sys/department/tree")
            .andExpect {
                status { isOk() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
    ...
    fun findSysDepartmentById() {
        mockMvc.get("/api/sys/department/id/$lastId")
            .andExpect {
                status { isOk() }
                content {
                    contentType(MediaType.APPLICATION_JSON)
    ...
    fun deleteSysDepartmentById() {
        mockMvc.delete("/api/sys/department/delete/$lastId") {
            contentType = MediaType.APPLICATION_JSON
        }
            .andExpect {
                status { isOk() }
