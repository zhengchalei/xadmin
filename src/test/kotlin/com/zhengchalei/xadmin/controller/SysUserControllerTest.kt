package com.zhengchalei.xadmin.controller
...
import com.zhengchalei.xadmin.modules.sys.domain.dto.SysUserUpdateInput
...
@WithMockUser(
    username = "admin",
    authorities = ["ROLE_admin", "sys:user:create", "sys:user:edit", "sys:user:delete", "sys:user:read", "sys:user:page", "sys:user:read"],
)
