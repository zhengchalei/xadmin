...
class SysDictItemService(
    private val sysDictItemRepository: SysDictItemRepository,
) {
     ...
     */
    fun findSysDictItemList(specification: SysDictItemPageSpecification) = this.sysDictItemRepository.findList(specification)
