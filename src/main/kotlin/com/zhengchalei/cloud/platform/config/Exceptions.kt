...
class LoginFailException(
    message: String = "登录失败, 请联系管理员",
) : ServiceException(message)

class TenantNotFoundException(
    message: String = "租户不存在",
) : ServiceException(message)
...
class UserPasswordErrorException(
    message: String = "密码错误",
) : ServiceException(message)
...
class CaptchaErrorException(
    message: String = "验证码错误",
) : ServiceException(message)

class SwitchTenantException(
    message: String = "切换租户失败",
) : ServiceException(message)
